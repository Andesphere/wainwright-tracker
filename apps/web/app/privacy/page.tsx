...
const sections: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Sentry (crash and error reports). When the app or website crashes or hits an error, Sentry receives a technical report: what went wrong, the app version, and your device model and system version. It does not receive your name, email address, notes or photos.",
