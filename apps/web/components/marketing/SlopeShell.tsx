...
// /guides/:slug, /fells, its book and fell pages, not found). Applies the
// design-slope CSS scope and pins the shared footer at the bottom. Children
// supply the nav + main content.
