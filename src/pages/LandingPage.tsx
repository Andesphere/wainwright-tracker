    ...
    <SlopeShell signedIn={signedIn}>
      ...
      <section className="hero">
        ...
        <div className="hero-text">
          ...
          <p className="hero-lede">
            A field journal for the two hundred and fourteen Wainwrights —
            log your round on a map you can hold in your pocket, and watch
            the years gather, summit by summit.
          </p>
      ...
      <section className="quiet-cta" id="journal">
        ...
        <div className="quiet-cta-inner">
          ...
          <p className="quiet-p">
            Two hundred and fourteen fells. No deadline, no streak, no badge
            for finishing. Just a journal you keep for as long as you walk.
          </p>
...
function FeatureIllu({ n }: { n: string }) {
  if (n === "01") {
    return (
      <svg viewBox="0 0 120 80" className="f-illu" aria-hidden>
        ...
        <line x1="55" y1="40" x2="55" y2="18" stroke="#3E6E54" strokeWidth="1" />
        <rect x="55" y="10" width="40" height="10" fill="#3E6E54" />
        <text
          x="75" y="17.5"
          textAnchor="middle" fill="#E8EDDC"
          fontSize="6"
  ...
  if (n === "02") {
    return (
      <svg viewBox="0 0 120 80" className="f-illu" aria-hidden>
        <rect x="0" y="0" width="120" height="80" fill="#E8EDDC" />
        <rect x="20" y="14" width="80" height="52" fill="#FAFAE8" stroke="#3E6E54" strokeWidth="0.8" />
        <line x1="34" y1="14" x2="34" y2="66" stroke="#3E6E54" strokeWidth="0.5" />
        {[24, 30, 36, 42, 48, 54].map((y, i) => (
          <line
            key={y}
            x1="40" y1={y}
            x2={92 - i * 4} y2={y}
            stroke="#3E6E54" strokeWidth="0.5" opacity="0.5"
          />
        ))}
  ...
  return (
    <svg viewBox="0 0 120 80" className="f-illu" aria-hidden>
      ...
      <g>
        <rect
          x="14" y="18" width="32" height="40"
          fill="#FAFAE8" stroke="#3E6E54" strokeWidth="0.8"
          transform="rotate(-8 30 38)"
        />
        <rect
          x="44" y="22" width="32" height="40"
          fill="#FAFAE8" stroke="#3E6E54" strokeWidth="0.8"
          transform="rotate(2 60 42)"
        />
        <rect
          x="74" y="18" width="32" height="40"
          fill="#FAFAE8" stroke="#3E6E54" strokeWidth="0.8"
